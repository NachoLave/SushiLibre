  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-pink-50 via-blue-50 to-green-50 flex flex-col items-center justify-center p-4">
      <div className="w-full max-w-md flex flex-col items-center">
        <div className="text-center mb-4 mt-2 md:mb-8 md:mt-4">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-foreground mb-1 md:mb-2 tracking-tight font-serif">
            Sushi Score
          </h1>
          <div className="h-1 w-16 bg-primary rounded-full mx-auto mb-2 md:mb-4"></div>
          <p className="text-sm md:text-base text-muted-foreground font-medium">
            El contador definitivo para sushi libre
          </p>
        </div>

        <div className="mb-2 -mt-20 md:-mt-4">
          <AnimatedSushi />
        </div>

        <div className="space-y-2 md:space-y-3 w-full mb-4 md:mb-8 -mt-4">
        ...
        {/* Footer */}
        <div className="text-center text-xs md:text-sm text-muted-foreground mt-4 md:mt-8">
